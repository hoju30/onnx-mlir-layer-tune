...
usage() {
  cat <<'USAGE_EOF'
Usage:
  compare_mobilenet11_dataset.sh [txt_dir] [options for compare_model11_dataset.sh]
...
Examples:
  compare_mobilenet11_dataset.sh
  compare_mobilenet11_dataset.sh ./temp/imagenette_val_224 --limit 100 --iters 1
  compare_mobilenet11_dataset.sh --out-dir /tmp/mobilenet11 --txt-dir ./temp/imagenette_val_224
USAGE_EOF
}
...
# Allow --txt-dir/--out-dir override in forwarded args.

...
LogicalResult ONNXUnsqueezeOpShapeHelper::computeShape() {
  ONNXUnsqueezeOpAdaptor operandAdaptor(operands, op->getAttrDictionary(), op->getPropertiesStorage());
...
LogicalResult ONNXUnsqueezeV11OpShapeHelper::computeShape() {
  ONNXUnsqueezeV11OpAdaptor operandAdaptor(operands, op->getAttrDictionary(), op->getPropertiesStorage());

...
def parse_args():
    ...
    p.add_argument("--ckpt", type=str, default="./imagenet100_resnet18_out/best.pth")
    p.add_argument("--class-map", type=str, default="./imagenet100_resnet18_out/class_map.json")
    p.add_argument("--onnx-out", type=str, default="./model/imagenet100_resnet18.onnx")
